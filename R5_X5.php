<?php
ob_start();
$API_KEY = '906449881:AAHZMk6a1rw25sG17kvQHKS--f6wo7f7pvk';
...
ادخل للقناة لتتعلم اكثر » @TBBOTS
",
...
$R5_X5 = "799273845";//هنا ايديك
$TTK       = $message->message_id;
$Kickmetxt = file_get_contents("kickme.txt");
if ($text =="اطردني" or $text == "ادفرني" or $text == "مغادره" and $from_id != $R5_X5){
...
if ($text =="اطردني" and $from_id == $R5_X5){
 bot("sendMessage",[
 "chat_id"=>$chat_id,
 "text"=>"
• لااستطيع طردك مطوري •
...
••┉┉┉┉┉┉┉┉┉┉┉┉┉•• 
💢❉ قم بمراسله المطور لصنع بوت مدفوع خاص بك › @R5_X5 ✅
📮 › 👨🏽‍💻
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
